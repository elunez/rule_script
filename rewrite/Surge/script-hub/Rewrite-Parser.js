...
!(async () => {
  ...
  for await (let [y, x] of body.entries()) {
    ...
    if (/\s((request|response)-body-(json-(add|del|replace)|replace-regex))\s/.test(x)) {
      ...
      const jsurl = 'https://cdn.jsdelivr.net/gh/elunez/rule_script@main/rewrite/Surge/script-hub/scripts/body-rewrite.js'
...
function getQxReInfo(x, y, mark) {
  ...
  let jsurl = /header/.test(hdorbd)
    ? 'https://cdn.jsdelivr.net/gh/elunez/rule_script@main/rewrite/Surge/script-hub/scripts/replace-header.js'
    : 'https://cdn.jsdelivr.net/gh/elunez/rule_script@main/rewrite/Surge/script-hub/scripts/replace-body.js'
  ...
  switch (targetApp) {
    ...
    case 'stash-stoverride':
      ...
      if (m2rType == null && mocktype == 'file') {
        ...
        jsurl = 'https://cdn.jsdelivr.net/gh/elunez/rule_script@main/rewrite/Surge/script-hub/scripts/echo-response.js'
